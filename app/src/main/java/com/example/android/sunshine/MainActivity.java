...
public class MainActivity extends AppCompatActivity {
    ...
    // COMPLETED (26) Within onCreateViewHolder, return a new ForecastAdapterViewHolder with the above view passed in
    // as a
    // parameter
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // COMPLETED (38) Create layoutManager, a LinearLayoutManager with VERTICAL orientation and
        // shouldReverseLayout ==
        //  false
        ...
        // COMPLETED (40) Use setHasFixedSize(true) on mRecyclerView to designate that all items in the list will
        // have the
        //  same size
