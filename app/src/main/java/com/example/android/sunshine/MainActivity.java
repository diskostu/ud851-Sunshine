...
public class MainActivity extends AppCompatActivity implements ForecastAdapterOnClickHandler,
    ...
    private final static String BUNDLE_KEY_WEATHER_LOCATION = "BUNDLE_KEY_WEATHER_LOCATION";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LoaderManager.getInstance(this).initLoader(WEATHER_LOADER_ID, null, this);
    }
    ...
    public Loader<String[]> onCreateLoader(int i, @Nullable final Bundle args) {
        return new AsyncTaskLoader<String[]>(this) {
            ...
            public String[] loadInBackground() {
                ...
                final String locationQuery = SunshinePreferences.getPreferredWeatherLocation(MainActivity.this);
                final URL weatherRequestUrl = NetworkUtils.buildUrl(locationQuery);

                try {
                    final String jsonWeatherResponse = NetworkUtils.getResponseFromHttpUrl(weatherRequestUrl);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_refresh) {
            invalidateData();
            LoaderManager.getInstance(this).restartLoader(WEATHER_LOADER_ID, null, this);
            return true;
        }
