...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTvErrorMessage = findViewById(R.id.tv_error_loading_content);
    ...
    // COMPLETED (8) Create a method called showWeatherDataView that will hide the error message and
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected void onPostExecute(String[] weatherData) {
            ...
            if (weatherData != null) {
                ...
                // visible
                /*
                 * Iterate through the array and append the Strings to the TextView. The reason
                 * why we add
